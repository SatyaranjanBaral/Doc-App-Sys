...
export const navbarStyles = {
  ...
  mobileMenuButton:
  "lg:hidden flex items-center justify-center w-10 h-10 ml-2 rounded-full bg-white border border-emerald-100 shadow-md transition-all duration-200 hover:bg-emerald-50 active:scale-95",
  ...
  mobileMenuContainer:
  "lg:hidden fixed top-16 left-4 right-4 z-50 rounded-2xl bg-white shadow-2xl border border-emerald-100 overflow-hidden animate-slideDown",
mobileMenuInner:
...
mobileItemInactive:
  ...
  mobileAuthContainer:
  "pt-4 mt-3 border-t border-emerald-100",
  ...
  mobileSignOutButton:
  "w-full py-3 rounded-xl bg-gradient-to-r from-amber-400 to-orange-500 text-white font-medium shadow-md hover:opacity-95 transition",
mobileLoginButton:
  "w-full py-3 rounded-xl border border-emerald-200 text-emerald-600 font-medium hover:bg-emerald-50 transition",

  
// Mobile menu button (clean round soft look)
