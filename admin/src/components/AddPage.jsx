...
import { Calendar, CheckCircle, Eye, EyeClosed, Plus, Trash2, User, X, XCircle } from 'lucide-react';
...
const AddPage = () => {
  ...
  async function handleAdd(e) {
    ...
    try {
      ...
      const API_BASE = "https://doc-app-sys.onrender.com/api";
    ...
    <div className={s.pageContainer}>
        ...
        <div className={s.maxWidthContainer + " " + s.formContainer}>
          ...
          <input 
                ...
                value={form.patients}
                onChange={(e) => 
                  setForm({...form,patients:e.target.value })}
                />
                <input 
                 className={s.inputBase} 
