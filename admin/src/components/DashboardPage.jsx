  ...
  useEffect(() => {
    ...
    async function loadPatientCount() {
      ...
      try {
        ...
        const body = await res.json().catch(() => ({}));
       // DashboardPage.jsx mein line 155-160 ke aaspas check karein
const count = Number(body?.totalUsers ?? body?.count ?? 0);
  ...
  return (
    <div className={s.statCard}>
      <div className={s.statCardContent}>
        <div className={s.statIconContainer}> {icon}

        </div>

        <div className="flex-1">
          <div className={s.statLabel}> {label}
  ...
  return (
    <div className={s.mobileDoctorCard}>
      ...
      <div className={s.mobileDoctorHeader}>
        ...
        <div className={s.mobileDoctorFee}> ₹ {d.fee}
