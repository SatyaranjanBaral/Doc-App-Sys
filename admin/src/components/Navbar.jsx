...
import { Calendar, Grid, Home, List, PlusSquare, UserPlus, Users,Menu, X } from 'lucide-react';
 ...
 <header className={ns.header}>
    <nav className={ns.navContainer}>
        <div className={ns.logoContainer}>
            ...
            <Link to ="/">
            <div className={ns.logoLink}>DAMS</div>
            <div className={ns.logoSubtext}>Doctor Appointment Management System</div>
            </Link>
