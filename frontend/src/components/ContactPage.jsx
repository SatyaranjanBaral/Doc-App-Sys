...
import { Mail, MapPin, MessagesSquare, Phone, SendHorizonal, Stethoscope, User } from 'lucide-react';
...
const ContactPage = () => {
  ...
  function handleSubmit(e) {
    ...
    const url = `https://wa.me/9938384478?text=${encodeURIComponent(text)}`;
        ...
        <div className={contactPageStyles.gridContainer}>
            <div className={contactPageStyles.formContainer}>
                ...
                <form onSubmit={handleSubmit} className={contactPageStyles.formSpace}>
                    ...
                    placeholder='doctorappointment@gmail.com' className={contactPageStyles.input}
                     />
                     {errors.email && (
                        <p className={contactPageStyles.error}>
                            {errors.email}
            ...
            <div className={contactPageStyles.infoContainer}>
                <div className={contactPageStyles.infoCard}>
                    ...
                    <p className={contactPageStyles.infoText}>
                        Rashulghar,Bhubaneswar,Odisha
                    </p>
                    <p className={contactPageStyles.infoItem}>
                        <Phone size={16}/> 9938384479
                    </p>
                    <p className={contactPageStyles.infoItem}>
                        <Mail size={16}/> doctor@yourclinic.com
                    </p>

                </div>
                <iframe
  src="https://www.google.com/maps?q=Agarwal+Hospital+Bhubaneswar&output=embed"
  className={contactPageStyles.map}
  title="Agarwal Hospital Bhubaneswar Map"
  loading="lazy"
  allowFullScreen
