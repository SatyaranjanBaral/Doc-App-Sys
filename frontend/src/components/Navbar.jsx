    ...
    className={`${navbarStyles.navbarContainer} ${showNavbar ? navbarStyles.navbarVisible : navbarStyles.navbarHidden}`}>
        ...
        <div className={navbarStyles.flexContainer}>
            ...
            <div className={navbarStyles.logoTextContainer}>
              ...
              <h1 className={navbarStyles.logoTitle}>DAMS</h1>
              <p className={navbarStyles.logoSubtitle}>Doctor Appointment Management System</p>
            ...
            <div className={navbarStyles.desktopNav}>
              <div className={navbarStyles.navItemsContainer}>
                {navItems.map((item) =>{
                  ...
                  return (
                    <Link key={item.href} to={item.href} className={`${navbarStyles.navItem} ${isActive
