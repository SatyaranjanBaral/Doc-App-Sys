...
function backendToFrontendStatus(s) {
  if (!s) return "pending";
  const v = String(s); // Case sensitive check remove karein ya properly handle karein
  if (v === "Pending") return "pending";
  if (v === "Confirmed") return "confirmed";
  if (v === "Completed") return "complete";
  if (v === "Canceled") return "cancelled"; // Model me ek 'l' hai, frontend me 2 use kar sakte hain
